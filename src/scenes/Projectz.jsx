...
const Project = ({ title, image, description, siteURL }) => {
  return (
    <div className="flex items-center p-4 gap-5 bg-white w-[90%] mx-auto justify-start h-60">
      ...
      <div className="w-[70%]">
        <h3 className="font-opensans underline text-lg font-semibold">
          {title}
        </h3>
        <p className="text-base max-width-[50%]">{description}</p>
        <a href={siteURL} className="mt-3">
          <button className="p-2 bg-blue mt-3 rounded-md text-white font-semibold">
            Visit Site
          </button>
        </a>
      </div>
    ...
    <div className="w-90% p-1 mt-2 mb-5">
      ...
      <div className="flex justify-center">
        <a href={siteURL} className="">
          <button className="p-2 bg-blue font-semiboldn rounded-lg mt-3 mx-auto font-semibold text-white">
            Visit Site
          </button>
        </a>
      </div>
    ...
    <div className="mt-4" id="projects">
      ...
      >
        ...
        <p className="mt-10 mb-10">
          Through these personal projects, I have gained valuable experience and
          knowledge in frontend web development, and I am excited to apply these
